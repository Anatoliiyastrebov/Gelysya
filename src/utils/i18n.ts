...
const translations: Record<Language, Translations> = {
  ru: {
    common: {
      ...
      fileRequired: 'Пожалуйста, загрузите хотя бы один файл',
      fileMaxCount: 'Можно загрузить максимум 5 файлов',
      fileUploadError: 'Ошибка загрузки файла, попробуйте ещё раз',
      fileStatusSelected: 'готов к отправке',
  ...
  en: {
    common: {
      ...
      fileMaxCount: 'You can upload up to 5 files',
      fileUploadError: 'File upload error, please try again',
      fileStatusSelected: 'ready to upload',
